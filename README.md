...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }
        ...
        .prod-price-box { text-align: right; min-width: 95px; }
...
<body>
    ...
    <div class="lista-container">
        ...
        <a href="https://wa.me/5563992112184?text=Olá! Quero ver os modelos de Copos do Stitch." class="lista-item">
            <div class="prod-info">
                <div class="prod-nome">Copos Stitch</div>
                <div class="prod-obs">Cores variadas disponíveis</div>
            </div>
            <div class="prod-price-box">
                <div class="prod-price">Ver</div>
            </div>
        </a>

        <a href="https://wa.me/5563992112184?text=Olá! Quero saber mais sobre o Material Escolar de R$ 2,99." class="lista-item">
            <div class="prod-info">
        ...
        <a href="https://wa.me/5563992112184?text=Olá! Quais perfumes vocês têm por R$ 49,99?" class="lista-item">
            <div class="prod-info">
        ...
        <a href="https://wa.me/5563992112184?text=Olá! Tenho interesse no Tablet no ATACADO (5 unidades)." class="lista-item">
            <div class="prod-info">
                ...
                <div class="prod-obs">Preço p/ Atacado (5 unid.)</div>
            </div>
            <div class="prod-price-box">
        ...
        <a href="https://wa.me/5563992112184?text=Olá! Quero comprar 1 Tablet no varejo." class="lista-item">
            <div class="prod-info">
    ...
    <a href="https://wa.me/5563992112184" class="wa-float">
        <svg style="width:32px;height:32px" viewBox="0 0 24 24"><path fill="currentColor" d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91C2.13 13.66 2.59 15.36 3.45 16.86L2.05 22L7.3 20.62C8.75 21.41 10.38 21.83 12.04 21.83C17.5 21.83 21.95 17.38 21.95 11.92C21.95 9.27 20.92 6.78 19.05 4.91C17.18 3.03 14.69 2 12.04 2M12.05 3.67C14.25 3.67 16.31 4.53 17.87 6.09C19.42 7.65 20.28 9.72 20.28 11.92C20.28 16.46 16.58 20.15 12.04 20.15C10.66 20.15 9.3 19.81 8.1 19.14L7.78 18.97L4.62 19.81L5.46 16.71L5.28 16.42C4.54 15.23 4.15 13.86 4.15 11.91C4.15 7.37 7.84 3.67 12.05 3.67M8.53 7.33C8.37 7.33 8.1 7.39 7.87 7.64C7.65 7.89 7 8.5 7 9.71C7 10.93 7.89 12.1 8.02 12.26C8.14 12.44 9.76 14.94 12.25 16.03C12.84 16.28 13.3 16.42 13.66 16.53C14.25 16.72 14.79 16.69 15.23 16.63C15.72 16.55 16.72 16.02 16.92 15.44C17.13 14.87 17.13 14.38 17.07 14.28C17.01 14.18 16.85 14.12 16.6 14C16.36 13.88 15.14 13.28 14.92 13.2C14.7 13.12 14.54 13.08 14.38 13.33C14.21 13.58 13.75 14.12 13.61 14.28C13.47 14.44 13.33 14.46 13.08 14.33C12.84 14.21 12.06 13.95 11.13 13.13C10.41 12.48 9.92 11.68 9.78 11.44C9.64 11.19 9.77 11.06 9.89 10.94C10 10.83 10.12 10.67 10.25 10.5C10.37 10.33 10.41 10.21 10.5 10.04C10.58 9.88 10.54 9.74 10.48 9.61C10.42 9.47 9.92 8.25 9.71 7.75C9.51 7.25 9.3 7.31 9.15 7.31C9 7.31 8.82 7.33 8.53 7.33Z" /></svg>
    </a>
